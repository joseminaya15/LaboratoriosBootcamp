...
<body>
    <section id="principal">
        ...
        <div class="container text-left relative">
            ...
            <div class="nombres">
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect close-login" onclick="gotoLogin()">Save and Close</button>
                <p>Welcome</p>
                <h2><?php echo $nombres.' '.$apellidos ?></h2>
            </div>
            <div class="mdl-calendario">
                <div class="mdl-card mdl-card-fecha mdl-date">
                    <div class="fecha"><p>TUE, Jan 30th</p></div>
                </div>
            ...
            <div class="mdl-calendario">
                <div class="mdl-card mdl-card-fecha mdl-date">
                    <div class="fecha"><p>WED, Jan 31th</p></div>
                </div>
                <div class="mdl-card-seats">
                    <?php echo $html1 ?>
                </div>
            ...
            <div class="mdl-calendario">
                <div class="mdl-card mdl-card-fecha mdl-date">
                    <div class="fecha"><p>THU, Feb 1st</p></div>
                </div>
                <div class="mdl-card-seats">
                    <?php echo $html2 ?>
                </div>
